...
import com.excellentsystem.TosanJaya.View.Dialog.DetailPembelianController;
...
public class DataPembelianController {
    ...
    @FXML
    private TableColumn<PembelianHead, String> jatuhTempoColumn;
    @FXML
    ...
    public void initialize() {
        ...
        supplierColumn.setCellValueFactory(cellData -> cellData.getValue().getSupplier().namaProperty());
