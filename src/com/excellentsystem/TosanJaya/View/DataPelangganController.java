...
import com.excellentsystem.TosanJaya.View.Dialog.DetailPelangganController;
...
public class DataPelangganController {
    ...
    @FXML
    private TableColumn<Pelanggan, Number> hutangColumn;
    @FXML
    private TableColumn<Pelanggan, Number> depositColumn;
    ...
    public void initialize() {
        ...
        depositColumn.setCellFactory((c) -> getTableCell(rp));
    ...
    private void hitungTotal() {
        ...
        for (Pelanggan p : filterData) {
            totalHutang = totalHutang + p.getHutang();
            totalDeposit = totalDeposit + p.getDeposit();
        }
        totalHutangLabel.setText(rp.format(totalHutang));
        totalDepositLabel.setText(rp.format(totalDeposit));
    }
